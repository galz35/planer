...
// Mocks de entidades para romper ciclos al cargar metadatos
jest.mock('./entities/usuario.entity', () => ({ Usuario: class { } }));
jest.mock('./entities/usuario-credenciales.entity', () => ({ UsuarioCredenciales: class { } }));
...
describe('AuthController', () => {
    ...
    describe('login', () => {
        it('should return tokens on valid credentials', async () => {
            ...
            const mockUser = { idUsuario: 1, correo: 'test@test.com', nombre: 'Test', rolGlobal: 'Admin' };
            const tokens = { accessToken: 'abc', refreshToken: 'xyz', user: mockUser };
