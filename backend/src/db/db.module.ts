 ...
 */
import { Module, Global, OnModuleDestroy, OnModuleInit, Injectable } from '@nestjs/common';
import { ConfigService } from '@nestjs/config';
import { obtenerPoolSql, cerrarPoolSql, isPoolConnected } from './sqlserver.provider';
