...
import { ejecutarQuery, ejecutarSP, Int, NVarChar, Decimal } from '../db/base.repo';
 ...
 */
export async function obtenerHistorialMensual(idTarea: number): Promise<TareaAvanceMensualDb[]> {
