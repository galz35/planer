 ...
 */
export async function agregarFase(idGrupo: number, idTareaNueva: number): Promise<void> {
 ...
 */
export async function esParteDeFase(idTarea: number): Promise<{ idGrupo: number; numeroParte: number } | null> {
