...
describe('Multi-Role Scenarios (E2E)', () => {
    ...
    beforeAll(async () => {
        ...
        adminToken = jwtService.sign({ sub: 1, email: 'admin@claro.com.ni', rol: 'Admin' }, { secret });
        managerToken = jwtService.sign({ sub: 2, email: 'manager@claro.com.ni', rol: 'Gerente' }, { secret });
        employeeToken = jwtService.sign({ sub: 3, email: 'empleado@claro.com.ni', rol: 'Empleado' }, { secret });
    });
