...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // ✅ Balance: UI rápida + menos llamadas inútiles
      staleTime: 15_000,                    // 15s: evita refetch por navegación rápida
      gcTime: 6 * 60 * 60 * 1000,           // 6h: PWA abierta todo el día (cache dura)

      // ✅ Triggers “inteligentes”
      refetchOnWindowFocus: true,           // al volver al navegador (si está stale)
      refetchOnReconnect: true,             // al volver internet
      refetchOnMount: false,                // no refetch automático por entrar a la ruta (si ya hay caché)
    ...
    mutations: {
      // ✅ Mutations: preferible NO reintentar en automático (evita duplicaciones)
      retry: 0,
    },
  },
});
